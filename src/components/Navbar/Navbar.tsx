...
const Navbar = () => {
  ...
  return (
    <header className="bg-transparent p-5 w-full sticky top-0 z-50">
      <nav className="w-11/12 rounded-full mx-auto px-5 border-2 py-2">
        <div
          className={`relative w-full mx-auto flex justify-between items-center bg-transparent font-semibold`}
        >
